...
class googleOnlineInsert():
    def __init__(self):
        ...
        self.credentials = service_account.Credentials.from_service_account_file(
            '/backstage/src/updateSite/google_file/account_file/utility-melody-416909-8dab6e1b360f.json',
            scopes=[
...
if __name__ == '__main__':
    ins = googleOnlineInsert()
    spreadsheet_id = ins.google_online_create("影视seo", "影视站")
    ins.google_online_batch( spreadsheet_id, "googlesearch@starry-journal-438106-m2.iam.gserviceaccount.com", "gusaomeishi@gmail.com")
