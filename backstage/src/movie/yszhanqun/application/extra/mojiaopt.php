...
return array (
  ...
  array (
    ...
    array (
      ...
      'info' => '视频筛选',
      'type' => '\'article\'',
      'title' => '$param[\'year\'].$param[\'area\'].$param[\'lang\'].$param[\'class\'].$obj[\'type_name\'].($param[\'level\']?\'推荐\':\'\').$param[\'letter\'].\' - \'.$maccms[\'site_name\']',
      'image' => 'mac_url_img(trim(mac_default($obj[\'type_logo\'],$mojia[\'other\'][\'share\'][\'image\'])))',
      'key' => 'mac_default($obj[\'type_key\'],mac_filter_html($obj[\'type_name\']))',
  ...
  array (
    ...
    array (
      'name' => '在线客服',
      'link' => 'https://wpa.qq.com/msgrd?v=3&uin=2598312299&site=qq&menu=yes',
      'state' => '0',
    ),
    'chat' => 
    array (
