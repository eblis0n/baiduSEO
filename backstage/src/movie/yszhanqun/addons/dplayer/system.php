...
<div class="layui-tab">
  <ul class="layui-tab-title">
    <li class="layui-this">Dplayer播放器</li>
    <li>基础设置</li>
    <li>前置广告设置</li>
    <li>暂停广告设置</li></ul>
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
      <blockquote class="layui-elem-quote layui-quote-nm">
        <p>欢迎使用影思演示 整合的苹果cmsV10 Dplayer播放器</p>
      </blockquote>
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            <td>名称</td>
            <td>
              <a href="https://shop253599846.taobao.com/" target="_blank">Dplayer播放器3.1.1</a></td>
            <td>1. PHP版本≥5.6</td></tr>
          <tr>
            <td>作者</td>
            <td>
              <a href="https://shop253599846.taobao.com/" target="_blank">影思演示</a></td>
            <td>2. 唯一官方网站，其他网站购买到本源码均为二次倒卖！</td></tr>
          <tr>
            <td>官方网站</td>
            <td>
              <a href="https://shop253599846.taobao.com/" target="_blank">https://shop253599846.taobao.com/</a></td>
          ...
          <tr>
            <td>更新时间</td>
            <td>
              <a href="https://shop253599846.taobao.com/" target="_blank">2020-1-11</a></td>
