...
layui.define('view', function(exports){
  ...
  var SHOW = 'layui-show', HIDE = 'layui-hide';
  var THIS = 'layui-this', DISABLED = 'layui-disabled', TEMP = 'template';
  var APP_BODY = '#LAY_app_body', APP_FLEXIBLE = 'LAY_app_flexible';
  var FILTER_TAB_TBAS = 'layadmin-layout-tabs';
  var APP_SPREAD_SM = 'layadmin-side-spread-sm', TABS_BODY = 'layadmin-tabsbody-item';
  var ICON_SHRINK = 'layui-icon-shrink-right', ICON_SPREAD = 'layui-icon-spread-left';
  var SIDE_SHRINK = 'layadmin-side-shrink', SIDE_MENU = 'LAY-system-side-menu';
